...
public class VehicleRepository {
    ...
    public void save(Vehicle vehicle) {
        vehicles.add(vehicle.setId(idGenerator.getAndIncrement()));
    }
    ...
    public void update(Integer id, VehicleUpdateRequest updateRequest) {
        var updatedVehicle = vehicles.stream()
                ...
                .findFirst()
                .map(v -> v.setLastReviewMileage(updateRequest.getLastReviewMileage()).setLastReviewDate(updateRequest.getLastReview()))
